...
public class ChunkType extends Type<Chunk> {
    ...
    public static Chunk deserialize(final int xPosition, final int yPosition, final int zPosition, final int xSize, final int ySize, final int zSize, final byte[] chunkData) {
        ...
        final LegacyNibbleArray blockDataArray = new LegacyNibbleArray(blockArray.length);
        final LegacyNibbleArray blockLightArray = new LegacyNibbleArray(blockArray.length);
        final LegacyNibbleArray skyLightArray = new LegacyNibbleArray(blockArray.length);
        ...
        for (int y = startY; y < endY; y++) {
            if (section == null || y % 16 == 0) {
                ...
                sectionSkyLight = new LegacyNibbleArray(16 * 16 * 16, 4);
                sectionBlockLight = new LegacyNibbleArray(16 * 16 * 16, 4);
            }
