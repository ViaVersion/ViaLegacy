package net.raphimc.vialegacy.protocols.snapshot.protocol1_16to20w14infinite.packets;
...
import net.raphimc.vialegacy.protocols.snapshot.protocol1_16to20w14infinite.ClientboundPackets20w14infinite;
                        ...
                        if (attributeIdentifier == null) {
                            ...
                            if (!com.viaversion.viaversion.protocols.protocol1_13to1_12_2.data.MappingData.isValid1_13Channel(attributeIdentifier)) {
                                if (!Via.getConfig().isSuppressConversionWarnings()) {
                                    ViaLegacy.getPlatform().getLogger().warning("Invalid attribute: " + key);
                                }
                                actualSize--;
