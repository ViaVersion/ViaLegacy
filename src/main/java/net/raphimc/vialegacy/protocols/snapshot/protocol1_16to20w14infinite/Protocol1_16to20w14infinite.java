...
import net.raphimc.vialegacy.protocols.snapshot.protocol1_16to20w14infinite.metadata.MetadataRewriter1_16to20w14infinite;
import net.raphimc.vialegacy.protocols.snapshot.protocol1_16to20w14infinite.packets.BlockItemPackets20w14infinite;
import net.raphimc.vialegacy.protocols.snapshot.protocol1_16to20w14infinite.packets.EntityPackets20w14infinite;
import net.raphimc.vialegacy.util.ItemBackwardsMappings;
