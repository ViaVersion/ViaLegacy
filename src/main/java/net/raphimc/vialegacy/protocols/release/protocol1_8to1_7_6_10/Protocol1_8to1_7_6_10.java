...
public class Protocol1_8to1_7_6_10 extends AbstractProtocol<ClientboundPackets1_7_2, ClientboundPackets1_8, ServerboundPackets1_7_2, ServerboundPackets1_8> {
    ...
    protected void registerPackets() {
        ...
        this.registerClientbound(ClientboundPackets1_7_2.ADD_PLAYER, wrapper -> {
            ...
            final List<EntityData> metadata = wrapper.read(Types1_7_6.METADATA_LIST); // metadata
        ...
        this.registerClientbound(ClientboundPackets1_7_2.ADD_MOB, new PacketHandlers() {
            ...
            public void register() {
                ...
                map(Types1_7_6.METADATA_LIST, Types1_8.ENTITY_DATA_LIST); // metadata
                handler(wrapper -> {
                    final EntityTracker tracker = wrapper.user().get(EntityTracker.class);
                    final int entityID = wrapper.get(Types.VAR_INT, 0);
                    ...
                    final List<EntityData> metadataList = wrapper.get(Types1_8.ENTITY_DATA_LIST, 0);
        ...
        this.registerClientbound(ClientboundPackets1_7_2.ADD_EXPERIENCE_ORB, new PacketHandlers() {
            ...
            public void register() {
                ...
                handler(wrapper -> {
                    ...
                    wrapper.set(Types.INT, 1, realignEntityY(EntityTypes1_10.EntityType.EXPERIENCE_ORB, wrapper.get(Types.INT, 1)));
                });
            }
        });
        ...
        this.registerClientbound(ClientboundPackets1_7_2.LEVEL_EVENT, wrapper -> {
            ...
            if (!disableRelativeVolume && effectId == 2006) { // block dust effect
                ...
                if (block.getId() != 0) {
                    ...
                    wrapper.write(Types.INT, Particle.BLOCK_DUST.ordinal());
            ...
            public void register() {
                ...
                handler(wrapper -> {
                    ...
                    if (mode == 2) { // interactAt
                        ...
                        final EntityTracker entityTracker = wrapper.user().get(EntityTracker.class);
                        final EntityTypes1_10.EntityType entityType = entityTracker.getTrackedEntities().get(wrapper.get(Types.INT, 0));
