...
public class Protocol1_7_2_5to1_6_4 extends StatelessTransitionProtocol<ClientboundPackets1_6_4, ClientboundPackets1_7_2, ServerboundPackets1_6_4, ServerboundPackets1_7_2> {
    ...
    protected void registerPackets() {
        ...
        this.registerClientbound(ClientboundPackets1_6_4.CHAT, new PacketHandlers() {
            @Override
            public void register() {
                map(Types1_6_4.STRING, Types.STRING, ChatComponentRewriter::toClient); // message
            }
        });
        ...
        this.registerClientbound(ClientboundPackets1_6_4.ADD_ENTITY, new PacketHandlers() {
            ...
            public void register() {
                ...
                handler(wrapper -> {
                    ...
                    if (EntityTypes1_10.getTypeFromId(wrapper.get(Types.BYTE, 0), true) == EntityTypes1_10.ObjectType.FALLING_BLOCK.getType()) {
        ...
        this.registerClientboundTransition(ClientboundPackets1_6_4.DISCONNECT,
                ClientboundStatusPackets.STATUS_RESPONSE, (PacketHandler) wrapper -> {
                    ...
                    protected void register() {
                        map(Types1_6_4.STRING, Types.STRING, ChatComponentRewriter::toClientDisconnect); // reason
                    }
    ...
    private void rewriteMetadata(final UserConnection user, final List<EntityData> metadataList) {
        for (EntityData metadata : metadataList) {
            if (metadata.dataType().equals(MetaType1_6_4.Slot)) {
                itemRewriter.handleItemToClient(user, metadata.value());
            }
            metadata.setDataType(MetaType1_7_6.byId(metadata.dataType().typeId()));
        }
    }
